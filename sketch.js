...
function preload(){
  hdg=loadImage("happy dog.png");
  dg=loadImage("Dog.png");
  sdg=loadImage("Lazy.png");
  ml=loadImage("milk.png");
  tb=loadImage("wood2.png");
  bl=loadImage("bowl.png");
  grd=loadImage("Garden.jpg");
  grd1=loadImage("garden.png");
  rr=loadImage("runningLeft.png");
  bd=loadImage("Bed Room.png");
  zz=loadImage("zz.png");
  ws=loadImage("Wash Room.png");
  bh=loadImage("Washroom.png");
